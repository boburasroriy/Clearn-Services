    ...
    <div class="container py-5">
        <div class="row align-items-center py-4">
            <div class="col-md-6 text-center text-md-left">
                <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase"> post ID is - {{$post->id}}</h1>
            </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    ...
                    <div class="media mb-4">
                        <img src="" alt="Image" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
